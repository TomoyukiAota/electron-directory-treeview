...
/**
 * Generates date and time when the photo was taken from the specified path.
...
/**
 * Gets formatted date and time from DateTimeOriginal in EXIF.
...
/**
 * Gets formatted date and time from GPSDateStamp and GPSTimeStamp in EXIF.
